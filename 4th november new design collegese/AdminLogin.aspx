<%@ Page Title="" Language="C#" MasterPageFile="~/UserContent.Master" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="_4th_november_new_design_collegese.WebForm2" %>
    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td style="width: 285px">
                <asp:TextBox ID="TextBox1" runat="server" BorderStyle="Outset" Width="238px"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td style="width: 285px; height: 38px">
                <asp:TextBox ID="TextBox2" runat="server" BorderStyle="Outset" TextMode="Password" Width="238px"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td style="width: 285px">
                <asp:Button ID="Button1" runat="server" BorderStyle="Dotted" Font-Bold="True" OnClick="Button1_Click1" Text="LOGIN" Font-Size="Larger" />
            </td>
            <td>
